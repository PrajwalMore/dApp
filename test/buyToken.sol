...
contract buyToken is ERC20{
    ...
    function sendToken(address _to,uint256 _amount) public{// making it internal so can't be called publically.(or use msg.value so if called publically anyone needs to send the value)
